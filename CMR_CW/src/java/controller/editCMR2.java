...
public class editCMR2 {
    ...
    public String editCMR() throws SQLException {
        CMRDataAccess.editCMRbycId(studentCount, meancw1, meancw2, meanexam, mediancw1, mediancw2, medianexam, distributioncw1type1, distributioncw2type1, distributionexamtype1, "3", cID);
