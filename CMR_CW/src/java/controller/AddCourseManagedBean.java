...
@ManagedBean
@SessionScoped
public class AddCourseManagedBean {
        ...
        if (fId == 0) {
            ...
            if (cName.equals("")) {
                ...
                if (cCode.equals("")) {
                    ...
                    Course course = CourseDataAccess.getCourseByCode(cCode);
                    if (course != null) {
                                ...
                                if (cEnd.equals("")) {
                                    ...
                                    try {
                                        ...
                                        if (StartDate.before(EndDate)) {
                                            CourseDataAccess.addCourse(fId, cCode, cName, cDescription, cStart, cEnd);
                                            message = null;
                                            checkSuccess = 1;
