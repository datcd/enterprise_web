...
@ManagedBean
@SessionScoped
public class EditCourseAssigned {
    public int CAID;
    public int cId;
    public int CMID;
    public int CLID;
    ...
    public String editCourseAssigned(){
         if (cId == 0) {
                        ...
                        if (cEnd.equals("")) {
                            ...
                            try {
                                ...
                                if (StartDate.before(EndDate)) {
                                    CourseassignedDataAccess.editAssigned(cId, CMID, CLID, cStart, cEnd, CAID);
                                    message = null;
                                    checkSuccess = 1;
                                    
                                    return "CourseAssigned?faces-redirect=true";
                                } else {
